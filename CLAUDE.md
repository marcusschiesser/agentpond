...
This project is indexed by GitNexus as **agentpond** (1217 symbols, 2862 relationships, 96 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
