...
- faa24c2: Add path-prefix handling for Google HTTP ingestion adapters.
- faa24c2: Simplify ingestion adapters with auth options and sink-owned object-store prefixes.
- faa24c2: Use Google Cloud project environment variables as Google ingest auth project id fallbacks.
